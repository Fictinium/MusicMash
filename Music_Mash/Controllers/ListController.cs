...
namespace Music_Mash.Controllers
{
    public class ListController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,CreationDate,Description")] List list)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,CreationDate,Description")] List list)
        {
            if (id != list.Id)
            {
                return NotFound();
